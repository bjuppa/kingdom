<template>
  <div class="space-inside visualize-vertical-rhythm">
    <h1 class="color-primary">Heading 1</h1>
    <p>
    ...
    <ul class="list-inline children:space-horizontally">
      <li>Inline&hellip;</li>
      <li>&hellip;list</li>
    </ul>
    ...
    <dl>
      ...
      <dd>This is a second definition description for the same term.</dd>
