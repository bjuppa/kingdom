<template>
  <main class="space-inside">
    ...
    <aside class="flex children:mt-1 space-children-horizontally w-readable text-center space-inside-children">
    ...
    <aside class="flex children:mt-1 space-children-horizontally w-readable text-center align-items-center justify-content-space-around ">
